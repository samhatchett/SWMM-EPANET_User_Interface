...
class Ui_frmAddVectorLayer(object):
    def setupUi(self, frmAddVectorLayer):
        ...
        self.cboEncoding = QtWidgets.QComboBox(self.groupBox)
        ...
        self.txtDataset = QtWidgets.QLineEdit(self.groupBox_2)
        ...
        self.actionBtnBox_Clicked = QtWidgets.QAction(frmAddVectorLayer)
        self.actionBtnBox_Clicked.setObjectName(_fromUtf8("actionBtnBox_Clicked"))
        self.actionBrowse_Clicked = QtWidgets.QAction(frmAddVectorLayer)
